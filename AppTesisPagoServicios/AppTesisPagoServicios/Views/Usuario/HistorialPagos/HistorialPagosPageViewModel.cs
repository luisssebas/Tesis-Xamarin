...
namespace AppTesisPagoServicios.Views
{
    ...
    public class HistorialPagosPageViewModel : INavigatedAware
    {
        ...
        public HistorialPagosPageViewModel(INavigationService navigationService, IUserDialogs userDialogs, IServicioUsuario servicioUsuario)
        {
        ...
        private async void PagoSeleccionarEjecutar(PagoCompletoMD item)
        {
            try
            {
                ...
                await _navigationService.NavigateAsync("HistorialPagoPage", parameters);
            }
            catch (Exception ex)
            {
